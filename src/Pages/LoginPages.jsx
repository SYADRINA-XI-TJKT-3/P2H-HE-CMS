...
export default function LoginPage() {
  ...
  const onSubmit = async () => {
    ...
    // Tambahkan navigasi ke homepage jika berhasil, misal:
    // navigate("/");
  };
  ...
  return (
    ...
    >
      <div className="bg-white rounded-none shadow-md max-w-md w-[380px] h-[620px] py-9 px-10">
        ...
        <div className="w-full h-[1px] bg-[#E2E2E2] my-6"></div>
        ...
        <form className="space-y-0">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-[300px] h-12 px-3 mt-2 border-2 text-[14px] text-[#8F8F8F] border-[#E2E2E2] rounded-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
              value={password}
          ...
          <div className="flex items-center justify-between mt-3 mb-5">
            ...
            >
              <input
                type="checkbox"
                id="remember"
                className="w-4 accent-[#FD5000] h-4"
              />
              Remember me
            </label>
            ...
            <Link
              to="/forgotpassword"
              className="text-[#1E1E1E] text-sm hover:underline"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-sm text-center text-[16px] text-[#8F8F8F] mt-4">
          ...
          <Link
            to="/register"
            className="text-gray-900 text-[16px] font-semibold hover:underline"
          >
            Sign up
          </Link>
        </p>
