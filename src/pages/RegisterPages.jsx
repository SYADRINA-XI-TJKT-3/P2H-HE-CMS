...
export default function RegisterPage() {
 ...
 const onSubmit = async () => {
  ...
  await auth.RegisterPage(dataRegister); // ← Panggil yang udah kamu update
};
      ...
      >
        <div className="bg-white px-10 py-8 shadow-[0_4px_15px_rgba(0,0,0,0.15)] sm:shadow-none w-[380px] h-[644px] max-w-md rounded-none">
          <div className="text-center mb-6">
            ...
            <p className="text-[16px] bg-[1E1E1E] mt-4">
              Content Management System
            </p>
          </div>
          <div className="h-[1px] w-full bg-[#E2E2E2] my-[24] mt-"></div>
          ...
          <form className="space-y-4">
            ...
            <div className="relative">
              <label className="text-[14px] block mb-none mt-5">
                Confirm Password
              </label>
              <input
